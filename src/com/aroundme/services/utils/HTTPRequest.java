package com.aroundme.services.utils;
...
import com.aroundme.utils.TrustAllSSLSocketFactory;
...
public class HTTPRequest {
	...
	public int execute(RequestMethod method) throws Exception {
		 ...
		 */
		if (!AroundMeUtils.isConnectionAvailable(context))
			return Constants.AroundMeDialogCodes.NETWORK_ERROR;
